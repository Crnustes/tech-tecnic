...
const pageCopy = {
  ...
  en: {
    metaTitle: 'AI Automation Agency in Bogota | Chatbots and Workflows | Tech Tecnic',
    metaDescription:
      'AI automation for businesses in Bogota and Latam. Chatbots, automated workflows, CRM integrations, and measurable ROI.',
    metaKeywords: [
...
export default async function AutomatizacionIAPage({
  ...
  const breadcrumbSchema = getBreadcrumbSchema(
    [
      ...
      { name: locale === 'es' ? 'Automatizacion con IA' : 'AI Automation', url: buildLocalizedUrl(path, locale) },
    ],
    locale
  );
