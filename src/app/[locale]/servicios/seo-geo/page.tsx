...
const pageCopy = {
  ...
  en: {
    metaTitle: 'SEO and Web Positioning in Bogota | Tech Tecnic',
    metaDescription:
      'Local SEO and web positioning services in Bogota. Increase visibility on Google, attract more clients, and improve your rankings with proven strategies.',
    metaKeywords: [
      'seo bogota',
      'web positioning colombia',
      'local seo bogota',
      'google my business',
      'google rankings',
      'seo agency colombia',
