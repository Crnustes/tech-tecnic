...
const pageCopy = {
  ...
  en: {
    metaTitle: 'Integrations and APIs in Bogota | Zapier, Make, HubSpot | Tech Tecnic',
    metaDescription:
      'System and API integration services in Bogota. Connect your tools with Zapier, Make, HubSpot, Zoho and more.',
    metaKeywords: [
