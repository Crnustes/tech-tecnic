        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <WhatsAppButton
                  message="Hola, quiero integrar mis herramientas y sistemas"
            ...
            {packages.map((pkg, i) => (
              ...
              >
                ...
                <PricingButton
                  planName={pkg.name}
                  service="integraciones"
                  message={`Hola, quiero información sobre ${pkg.name} de Integraciones`}
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="p-8 rounded-2xl bg-slate-900/50 border border-emerald-500/30">
              ...
              <WhatsAppButton
                message="Hola, necesito una API personalizada para mi proyecto"
                service="integraciones"
